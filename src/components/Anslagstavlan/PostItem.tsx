          ...
          <div className="w-full overflow-hidden bg-primary-300 p-0 card card-base rise-animation lg:h-[270px] flex">
            ...
            <div className="font-medium grow flex flex-col max-lg:justify-between lg:headline-m py-5 pl-5 pr-6 lg:py-10 lg:pl-10 lg:pr-16 lg:w-96 lg:gap-3.5">
              {/* <h2
                ...
                className="max-lg:line-clamp-1  max-w-full lg:w-full"
              />
              <p
                dangerouslySetInnerHTML={{
                  __html: post.excerpt.rendered,
                }}
                className="line-clamp-3 break-words paragraph-lg text-sm lg:text-base h-14 lg:w-auto lg:h-full lg:grow max-w-full"
              /> */}
              {/* <h2 className="max-lg:line-clamp-1  max-w-full lg:w-full">
                {title}
              </h2> */}
              <h2 className="max-lg:line-clamp-1 lg:line-clamp-2 max-w-full lg:w-full">
                {title}
              </h2>
              <p className="line-clamp-3 max-lg:mt-1 break-words paragraph-lg text-sm lg:text-base h-[60px] lg:h-[76px] lg:w-auto  lg:grow max-w-full">
                {previewText}
              </p>
              <div className="flex max-lg:mt-2 text-sm lg:text-xl text-primary-500 justify-start items-center">
                <div className="italic font-medium capitalize">
